  ...
  const TabButton = ({ id, label, icon: Icon, active, onClick }) => {
    return (
      ...
      >
        ...
        {label}
        {id === 'users' && <span className="ml-2 bg-blue-100 text-blue-800 text-xs font-medium px-2 py-0.5 rounded-full">{adminData?.usersCount || 0}</span>}
        {id === 'wheels' && <span className="ml-2 bg-indigo-100 text-indigo-800 text-xs font-medium px-2 py-0.5 rounded-full">{adminData?.wheelsCount || 0}</span>}
        {id === 'customers' && <span className="ml-2 bg-green-100 text-green-800 text-xs font-medium px-2 py-0.5 rounded-full">{adminData?.customersCount || 0}</span>}
      </button>
    );
  };
            ...
            {activeTab === 'users' && (
              <div className="relative">
                <input
                  ...
                  className="px-4 py-2 pl-10 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr className="text-xs text-gray-500 uppercase tracking-wider">
                    <th className="px-6 py-3 text-left">#</th>
                    <th className="px-6 py-3 text-left">{t.instructions}</th>
                    <th className="px-6 py-3 text-left">{t.createdDate}</th>
                    <th className="px-6 py-3 text-center">{t.scans}</th>
                    <th className="px-6 py-3 text-center">{t.lots}</th>
                    <th className="px-6 py-3 text-center">{t.reviewLink}</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
              ...
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr className="text-xs text-gray-500 uppercase tracking-wider">
                    ...
                    <th className="px-6 py-3 text-left">{t.prize}</th>
                    <th className="px-6 py-3 text-center">{t.status}</th>
                    <th className="px-6 py-3 text-center">{t.enriched}</th>

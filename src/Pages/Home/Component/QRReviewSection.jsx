    ...
    return (
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 p-6 bg-gray-100">
            {sections.map((section, index) => (
                <div key={index} className={`p-6 border border-gray-200 rounded-2xl hover:shadow-2xl shadow-lg hover:text-white hover:bg-[#2098F3] h-[250px] flex flex-col items-start ${section.bgColor}`}>

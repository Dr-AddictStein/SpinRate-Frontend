export const fr = {
  ...
  forgotInstruction: "Entrez votre e-mail pour recevoir un code OTP à 6 chiffres.",
  sendOTP: "Envoyer le code",
  sending: "Envoi...",
  otpTitle: "Vérifier le code",
  otpInstruction: "Entrez le code à 6 chiffres envoyé à votre e-mail.",
  otpPlaceholder: "Code à 6 chiffres",
  verify: "Vérifier",
  verifying: "Vérification...",
  resetTitle: "Réinitialiser le mot de passe",
  resetInstruction: "Créez un nouveau mot de passe et confirmez-le.",
  newPassword: "Nouveau mot de passe",
  confirmNewPassword: "Confirmer le nouveau mot de passe",
  resetPassword: "Réinitialiser le mot de passe",
  resetting: "Réinitialisation...",
  backToLogin: "Retour à la connexion",
  otpResent: "Code envoyé à votre e-mail",
  otpVerified: "Code vérifié avec succès",
  passwordResetSuccess: "Mot de passe réinitialisé. Veuillez vous connecter.",
  passwordsDoNotMatch: "Les mots de passe ne correspondent pas",
  invalidOtpFormat: "Veuillez entrer un code OTP à 6 chiffres valide",

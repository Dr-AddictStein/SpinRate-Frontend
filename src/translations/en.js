export const en = {
  ...
  forgotInstruction: "Enter your email to receive a 6-digit OTP.",
  sendOTP: "Send OTP",
  sending: "Sending...",
  otpTitle: "Verify OTP",
  otpInstruction: "Enter the 6-digit code sent to your email.",
  otpPlaceholder: "6-digit code",
  verify: "Verify",
  verifying: "Verifying...",
  resetTitle: "Reset Password",
  resetInstruction: "Create a new password and confirm it.",
  newPassword: "New Password",
  confirmNewPassword: "Confirm New Password",
  resetPassword: "Reset Password",
  resetting: "Resetting...",
  backToLogin: "Back to Login",
  otpResent: "OTP sent to your email",
  otpVerified: "OTP verified successfully",
  passwordResetSuccess: "Password reset successful. Please log in.",
  passwordsDoNotMatch: "Passwords do not match",
  invalidOtpFormat: "Please enter a valid 6-digit OTP",
